...
def draw_image(url, name):
    ...
    cv2.imencode(".png", bg)[1].tofile("img/" + name)
if __name__ == "__main__":
    ...
    for a in images:
        try:
            ...
            # draw_image(image_url, "%s_%s.png" % (name_prefix, name_suffix))
            index = index + 1
