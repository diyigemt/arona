...
const ConfigRouter: Array<RouteRecordRaw> = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import("@/views/config/config/ConfigAronaBlockly.vue"),
      },
      {
        ...
        component: () => import("@/views/config/config/ConfigAronaMain.vue"),
      },
      {
        ...
        component: () => import("@/views/config/config/ConfigRandomReply.vue"),
      },
      {
        ...
        component: () => import("@/views/config/config/ConfigRandomReplyLabel.vue"),
      },
    ],
  },
];
